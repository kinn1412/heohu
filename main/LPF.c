...
float LPF_coefficients[10] = 
{
// Scaled for floating point

    0.0715165343386344, 0.1430330686772688, 0.0715165343386344, 1.2128120926202186, -0.3840041622865537,// b0, b1, b2, a1, a2
    0.03125, 0.0625, 0.03125, 1.4797988943972167, -0.6886769530538616// b0, b1, b2, a1, a2
...
int LPF_filterBlock( LPFType * pThis, float * pInput, float * pOutput, unsigned int count )
{
    ...
    executionState.pCoefficients = LPF_coefficients;    // Each call to filterBiquad() will advance pState and pCoefficients to the next biquad
